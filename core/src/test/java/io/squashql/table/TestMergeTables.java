...
class TestMergeTables {
  ...
  void mergeWithEmptyLeftTable() {
    ...
    Table rightTable = new ColumnarTable(
            List.of(new Header(new FieldWithStore(null, "typology", String.class), false),
                    new Header(new FieldWithStore(null, "category", String.class), false),
  ...
  void mergeFailWithCommonMeasures() {
     ...
     */
    Table rightTable = new ColumnarTable(
            List.of(new Header(new FieldWithStore(null, "category", String.class), false),
                    new Header(new FieldWithStore(null, "price.sum", int.class), true)),
            Set.of(new AggregatedMeasure("price.sum", "price", "sum")),
            List.of(
  ...
  void mergeTablesWithSameColumns() {
    ...
    Table rightTable = new ColumnarTable(
            List.of(new Header(new FieldWithStore(null, "typology", String.class), false),
                    new Header(new FieldWithStore(null, "category", String.class), false),
                    new Header(new FieldWithStore(null, "price.avg", int.class), true)),
  ...
  void mergeTablesWithDifferentColumns() {
    ...
    Table rightTable = new ColumnarTable(
            List.of(new Header(new FieldWithStore(null, "typology", String.class), false),
                    new Header(new FieldWithStore(null, "category", String.class), false),
                    new Header(new FieldWithStore(null, "company", String.class), false),
                    new Header(new FieldWithStore(null, "price.avg", int.class), true)),
            Set.of(new AggregatedMeasure("price.avg", "price", "avg")),
            List.of(
  ...
  void mergeThreeTables() {
    ...
    Table table1 = new ColumnarTable(
            List.of(new Header(new FieldWithStore(null, "typology", String.class), false),
                    new Header(new FieldWithStore(null, "Turnover", double.class), true),
                    new Header(new FieldWithStore(null, "Margin", double.class), true)),
    ...
    Table table2 = new ColumnarTable(
            List.of(new Header(new FieldWithStore(null, "typology", String.class), false),
                    new Header(new FieldWithStore(null, "category", String.class), false),
                    new Header(new FieldWithStore(null, "PriceVariation", double.class), true)),
    ...
    Table table3 = new ColumnarTable(
            List.of(new Header(new FieldWithStore(null, "company", String.class), false),
                    new Header(new FieldWithStore(null, "PriceIndex", double.class), true)),
  ...
  void mergeThreeUnorderedTables() {
     ...
     */
    Table table2 = new ColumnarTable(
            List.of(new Header(new FieldWithStore(null, "PriceVariation", double.class), true),
                    new Header(new FieldWithStore(null, "category", String.class), false),
                    new Header(new FieldWithStore(null, "typology", String.class), false)),
            Set.of(new AggregatedMeasure("PriceVariation", "price_variation", "avg")),
            List.of(
