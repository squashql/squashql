...
public class TestMultipleColumnsSorter {
  ...
  private void print(List<Object> c1, List<Object> c2, List<Object> c3, int[] sort) {
    List<Header> headers = Arrays.asList(
            new Header(new FieldWithStore(null, "c1", String.class), false),
            new Header(new FieldWithStore(null, "c2", String.class), false),
            new Header(new FieldWithStore(null, "c3", String.class), false));
