...
public class TestMeasureExpression {
  ...
  void test() {
    ...
    Assertions.assertThat(plus.expression()).isEqualTo("ps + qs");
    Assertions.assertThat(divide.expression()).isEqualTo("ps / (ps + qs)");
    ...
    Assertions.assertThat(divide.expression()).isEqualTo("ps / plus");
