...
public class TestJavascriptLibrary {
  ...
  void testReadJsonBuildFromQueryPivot() {
    ...
    Assertions.assertThat(qjs).isEqualTo(new PivotTableQueryDto(q, tableFields(List.of("a")), tableFields(List.of("b")), true));
  }
  ...
  void testReadJsonBuildFromQueryMergePivot() {
    ...
    PivotTableQueryMergeDto pivotTableQueryMergeDto = new PivotTableQueryMergeDto(query, tableFields(List.of("a")), tableFields(List.of("b")), false);
  ...
  void testQueryResult() {
    String name = "build-from-query-result.json"; // The content of this file is generated by the js code.
  ...
  void testPivotQueryResult() {
    String name = "build-from-pivot-query-result.json"; // The content of this file is generated by the js code.
